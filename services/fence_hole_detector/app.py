...
# detector = OnnxDetector(onnx_path=ONNX_PATH, conf=CONF, roi=os.getenv("FENCE_ROI","none"),
...
#         fired_alert=int(1 if detected else 0),  # אין Voting אמיתי במקרה שלך, זו אינדיקציה לזיהוי
