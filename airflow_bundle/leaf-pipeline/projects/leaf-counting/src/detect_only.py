...
# --- HARD PATCH: עקיפת cpuinfo/ultralytics באופן גורף (מונע Popen('')) ---
try:
    import cpuinfo as _ci
    _ci.get_cpu_info = (lambda: {"brand_raw": "unknown"})
except Exception:
    pass
try:
    import ultralytics.utils.torch_utils as _tu
    _tu.get_cpu_info = (lambda: "unknown")
except Exception:
    pass
# --- end hard patch ---
...
import cpuinfo
try:
    print("cpu brand:", cpuinfo.get_cpu_info().get("brand_raw"))
except Exception as e:
    print("cpuinfo error:", repr(e))
