...
# - WatermarkStrategy מתוך pyflink.common (תואם 1.18)
# - פיצול הצלחות ל-inference.dispatched.<team> ושגיאות ל-DLQ
# """
...
# # WatermarkStrategy/Types – ב-1.18 מייבאים מהחבילה common
...
#         # 3) אוכפים אך ורק bucket+key; image_uri אסור
...
#         # 4) headers + payload: שולחים רק bucket/key לשירות
#         headers = {
