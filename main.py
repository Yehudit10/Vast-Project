...
# # # # qt_root = Path(PyQt5.__file__).with_name('Qt5')
...
# # # import os
# # # from pathlib import Path
# # # import PyQt5  # keep this import here (before any QtWebEngine import)
...
# # # # from PyQt5.QtWebEngineCore import QtWebEngine
# # # # QtWebEngine.initialize()
# # # from PyQt5 import QtWebEngine
# # # QtWebEngine.QtWebEngine.initialize()

# # # import sys, traceback
# # # qt_plugins = Path(PyQt5.__file__).with_name('Qt5') / 'plugins'
# # # os.environ.setdefault('QT_PLUGIN_PATH', str(qt_plugins))
# # # os.environ.setdefault('QT_QPA_PLATFORM_PLUGIN_PATH', str(qt_plugins / 'platforms'))
...
# # # # Ensure WebEngine is loaded on PyQt5 (initializes resources)
...
# # # 1) Import PyQt5 first, but nothing from QtWebEngine yet
# # import PyQt5
...
# # # Importing QtWebEngine early (PyQt5 style)
# # from PyQt5 import QtWebEngine
# # # In PyQt5 the initialize() lives under QtWebEngine.QtWebEngine
# # try:
...
# # --- Resolve PyQt5/Qt5 paths (prefer ASCII 8.3 short paths) ---
# qt_root = Path(PyQt5.__file__).with_name("Qt5")
# qt_plugins = qt_root / "plugins"
# qt_bin = qt_root / "bin"
# qt_res = qt_root / "resources"
...
#     # Initialize WebEngine explicitly (PyQt5)
#     try:
#         QtWebEngine.QtWebEngine.initialize()
#     except Exception:
#         pass
...
# ---------- Hard bootstrap for PyQt5 WebEngine on Windows ----------
...
import PyQt5  # keep before any QtWebEngine import
...
from PyQt5 import QtWebEngine
QtWebEngine.QtWebEngine.initialize()
from PyQt5 import QtWebEngineWidgets  # ensure widgets module loads as well
